    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto">
            <div class="mb-6 text-center">
                ...
                <p class="text-slate-500 text-sm mt-1">Detayları belirle ve arkadaşlarını davet et.</p>
            </div>

            <div class="glass p-8 rounded-2xl">
                <form action="{{ route('events.store') }}" method="POST" class="space-y-8" x-data="{ locationMode: 'common', collectLocation: true }">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="relative group">
                            ...
                            <input type="date" id="start_date" name="start_date" value="{{ old('start_date') }}" class="input-field" required />
                        ...
                        <div class="relative group">
                            ...
                            <input type="date" id="end_date" name="end_date" value="{{ old('end_date') }}" class="input-field" required />
                    ...
                    <div class="flex items-center justify-end gap-4 pt-4">
                        <a href="{{ route('dashboard') }}" class="text-slate-500 hover:text-slate-800 font-medium text-sm">İptal</a>
                        <button type="submit" class="btn-primary px-10">
                            Etkinlik Oluştur &rarr;
                        </button>
                    </div>
                </form>
            </div>
